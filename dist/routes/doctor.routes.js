...
router.get('/shortcuts', doctorController.getShortcuts);
router.post('/shortcuts', doctorController.addShortcut);
router.delete('/shortcuts/:type/:text', doctorController.deleteShortcut);
